...
function Homepage() {
  ...
  const content = [
    {
      ...
      content: (
        <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(to_bottom_right,#FFA07A,#FF7F50)] text-white">
          Deposit Money
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(to_bottom_right,#98FB98,#90EE90)] text-white">
          Online Purchases
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(to_bottom_right,#FFB6C1,#FFA07A)] text-white">
          Instant Transfers
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(to_bottom_right,#E6E6FA,#DDA0DD)] text-white">
          Payment API
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(to_bottom_right,#87CEEB,#87CEFA)] text-white">
          Global Payments
        </div>
      ),
    },
  ...
  return (
    <div className='  text-center text-black overflow-x-hidden' >
      <section className='  w-[100lvw] h-[80lvh] '>
        ...
        <div className='relative w-[100lvw] flex flex-col justify-center items-center'>
          <header className='w-[80lvw] h-[10lvh] flex justify-around  items-center  text-black z-10 '>
          ...
          <div className='flex justify-between  w-full h-[80lvh] items-center '>
            <div className='flex-1/2 text-left pl-30 flex-col gap-4 justify-start items-start flex'>
              <div className='text-black text-5xl font-bold'>
                <h1>A smarter way to manage online transactions —<span className='text-highlight'> all in one place.</span></h1>
              </div>
            ...
            <div className="illustration flex  justify-center items-center overflow-hidden">
              <Image src={LeftHand} className='translate-y-40 max-h-[60lvh] w-auto' alt='first illustration'></Image>
              <Image src={RightHand} alt='first illustration ' className='max-h-[60lvh] w-auto'></Image>
            </div>
      ...
      <section className='w-[100lvw] px-60 relative z-10 mt-20 bg-gradient-to-b from-transparent to-gray-50/30'>
        <div className="py-0">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-x-0 gap-y-8">
            {[
              ...
              <div key={index} className={`p-6 ${index % 4 !== 3 ? 'border-r' : ''} border-dashed border-gray-200/50`}>
                <p className="text-xl font-light tracking-wide text-center text-gray-700 font-geist-sans hover:text-highlight transition-colors duration-300">{pays}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className='w-[100lvw] h-[70lvh] bg-dark
            flex justify-center items-center relative
            '>

        <div className='w-full p-30 pr-0        border-y-4 border-[#FF6600] 
 overflow-hidden h-[70lvh] relative   flex  items-center'>
          ...
          <div className='  w-[70lvw] h-[70lvw] absolute right-0 top-0 z-0 translate-x-1/3'>
            <World
              globeConfig={{
                ...globeConfig,
                globeColor: "#062056",
